...
parsers = {
    ...
    0: [
        ...
        None,
        None,
        lambda x: list(x[0].encode("ascii")) + [0x00],
    ],
    1: [
        lambda x: "".join(map(chr, x)),
        None,
    ...
    3: [
        lambda x: struct.unpack("<B", bytearray(x))[0],
        None,
        None,
        lambda x: list(struct.pack("<BB", *x)),
    ],
    ...
    # Homing function
    30: [
        lambda x: struct.unpack("<" + "f" * 4, bytearray(x)),
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<" + "f" * 4, *x)),
    ],
    31: [
        None,
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<f", *x)),
    ],
    32: [
        lambda x: struct.unpack("<Bf", bytearray(x)),
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<Bf", *x)),
    ],
    # Handhold teaching
    ...
    # End effector
    60: [
        lambda x: struct.unpack("<" + "f" * 3, bytearray(x)),
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<" + "f" * 4, *x)),
    ],
    ...
    # JOG
    70: [
        lambda x: struct.unpack("<" + "f" * 8, bytearray(x)),
        None,
        None,
        lambda x: list(struct.pack("<" + "f" * 8, *x)),
    ],
    71: [
        lambda x: struct.unpack("<" + "f" * 8, bytearray(x)),
        None,
    ...
    72: [
        lambda x: struct.unpack("<" + "f" * 2, bytearray(x)),
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<" + "f" * 2, *x)),
    ],
    73: [
        None,
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<" + "B" * 2, *x)),
    ],
    74: [
        lambda x: struct.unpack("<" + "f" * 2, bytearray(x)),
        None,
    ...
    84: [
        ...
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<Bffff", *x)),
    ],
    85: [
        lambda x: struct.unpack("<" + "f" * 2, bytearray(x)),
        None,
    ...
    86: [
        ...
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<Bfffff", *x)),
    ],
    87: [
        lambda x: struct.unpack("<" + "f" * 3, bytearray(x)),
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<" + "f" * 3, *x)),
    ],
    88: [
        None,
        None,
    ...
    # Continuous path
    90: [
        lambda x: struct.unpack("<fffB", bytearray(x)),
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<fffB", *x)),
    ],
    91: [
        None,
        None,
    ...
    120: [
        ...
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<BBBH", *x)),
    ],
    # EIO
    130: [
        lambda x: struct.unpack("<B" * 2, bytearray(x)),
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<" + "B" * 2, *x)),
    ],
    ...
    132: [
        lambda x: struct.unpack("<Bff", bytearray(x)),
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<Bff", *x)),
    ],
    ...
    135: [
        ...
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<BBf", *x)),
    ],
    137: [
        lambda x: struct.unpack("<B" * 3, bytearray(x)),
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<" + "B" * 3, *x)),
    ],
    138: [
        lambda x: struct.unpack("<B", bytearray(x)),
        None,
        lambda x: struct.unpack("<Q", bytearray(x))[0],
        lambda x: list(struct.pack("<" + "B" * 3, *x)),
    ],
    ...
    153: [
        lambda x: struct.unpack("<B" * 5, bytearray(x)),
        None,
        None,
        lambda x: list(struct.pack("<B" * 5, *x)),
    ],
    154: [
        lambda x: struct.unpack("<B" * 4, bytearray(x)),
        None,
        None,
        lambda x: list(struct.pack("<B" * 4, *x)),
    ],
    155: [
        lambda x: struct.unpack("<B" * 4, bytearray(x)),
        None,
